=== WebSMSLK WordPress - WooCommerce ===

Tags: order notification, order SMS Sri Lanka, SMS order Sri Lanka, seller notification, sms, SMSAlert, WebsmsLK, sms sri lanka,, woocommerce sms, woocommerce order sms, woocommerce order notification, woocommerce sms, sms integration, sms plugin, sms notification, two-step-verification, otp, mobile verification, verification, mobile, phone, sms, one time, password, sms verification
...
This is a WooCommerce add-on. By Using this plugin admin and buyer can get notification about their order via sms using newsletters.lk.
...
= WebSMSLK - WooCommerce (Key Features) =
...
1. Unzip the package newsletters.lk.zip on you computer.
2. Upload the unzipped folder the /wp-content/plugins/ directory.
3. Activate the plugin through the Plugins menu in WordPress.
4. Goto Woocommerce settings and configure your Newsletters.lk SMS.

= New Install via the WordPress uploader =

1. Click Plugins > Add New inside of your WordPress install.
2. Click Upload and select the package newsletters.lk.zip
3. Activate the plugin through the Plugins menu in WordPress.
4. Goto Woocommerce settings and configure your WebsmsLK.
...
2. Unzip the package newsletters.lk.zip on you computer.
...
There is no provision to integrate any other SMS Gateway, we only support (https://newsletters.lk/) SMS Gateway.

= How do i change Sender id? =

You can request the sender id after login to your (https://newsletters.lk/) account, from manage sender id.
