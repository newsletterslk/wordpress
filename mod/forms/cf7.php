<?php
	...
	class ContactForm7 extends FormInterface
	{
		...
		function Websms_wpcf7_shortcode_handler( $tag ) 
		{
			...
			// $this->phoneFieldKey = $tag->name;
			// $this->phoneFormID = 'input[name='.$tag->name.']';
		...
		public function add_Websms_phone_tag() {
			if (class_exists( 'WPCF7_TagGenerator' ) )
			{
				...
				$tag_generator->add( 'billing_phone', __( 'Newsletters.lk PHONE', 'contact-form-7' ),
									array($this, 'Websms_wpcf7_tag_generator_text') );
				$tag_generator->add( 'websms_otp_input', __( 'Newsletters.lk SMS OTP', 'contact-form-7' ),
									array($this, 'Websms_wpcf7_tag_generator_text') );					
			}
		}
		...
		/*
	* Function for Newsletters.lk SMS integration with contact form 7.
	*/
